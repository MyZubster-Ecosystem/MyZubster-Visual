...
- `assets/brand/` — logos and visual identity
- `assets/ecosystem/` — ecosystem architecture diagrams
- `assets/ui/` — dashboards and interface references
- `assets/maps/` — maps and geographic visuals
